...
public class Palindrom_partitions_Recursion {

	public static void main(String[] args)
	{
		String input="Hello Kavya.!";
		System.out.println("All possible palindrome partitions is: ");
	...
	private static void allPalPartitonsUtil(ArrayList<ArrayList> 
	allPart,Deque currPart, int start, int n, String input)
    {
		 if (start >= n)
		 {
